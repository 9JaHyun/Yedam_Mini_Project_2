...
public class ScreeningInit {
    ...
    public void init() {
        ...
        List<Screening> screenings = List.of(
                new Screening(150, LocalDateTime.of(day25, LocalTime.of(9, 30))
                        , movieService.findByName("스파이더맨")
                        , theaterService.findTheater("서울", "강남", "1관"))
                , new Screening(100, LocalDateTime.of(day25, LocalTime.of(10, 0))
                        , movieService.findByName("스파이더맨")
                        , theaterService.findTheater("서울", "강남", "2관"))
                , new Screening(100, LocalDateTime.of(day25, LocalTime.of(11, 0))
                        , movieService.findByName("스파이더맨")
                        , theaterService.findTheater("서울", "강동", "1관"))
                , new Screening(100, LocalDateTime.of(day26, LocalTime.of(9, 30))
                        , movieService.findByName("모가디슈")
                        , theaterService.findTheater("서울", "강남", "3관"))
                , new Screening(100, LocalDateTime.of(day26, LocalTime.of(10, 0))
                        , movieService.findByName("스파이더맨")
                        , theaterService.findTheater("서울", "강남", "1관"))
                , new Screening(100, LocalDateTime.of(day26, LocalTime.of(11, 0))
                        , movieService.findByName("모가디슈")
                        , theaterService.findTheater("대구", "대구이시아", "3관"))
                , new Screening(100, LocalDateTime.of(day26, LocalTime.of(12, 30))
                        , movieService.findByName("매트릭스")
                        , theaterService.findTheater("대구", "대구신세계(동대구)", "1관"))
                , new Screening(100, LocalDateTime.of(day25, LocalTime.of(11, 30))
                        , movieService.findByName("듄")
                        , theaterService.findTheater("대구", "대구신세계(동대구)", "2관"))
                , new Screening(100, LocalDateTime.of(day25, LocalTime.of(11, 30))
                        , movieService.findByName("스파이더맨")
                        , theaterService.findTheater("대구", "대구신세계(동대구)", "3관"))
                , new Screening(100, LocalDateTime.of(day26, LocalTime.of(11, 30))
                        , movieService.findByName("스파이더맨")
